...
- [ ] Ticket 018B education resource upload flow complete.
- [ ] Ticket 018C education UI persistence complete.
- [ ] Ticket 018D supplement UI persistence complete.
- [ ] Ticket 018E education/supplement E2E coverage complete.
- [ ] Ticket 018F mandatory review gate complete.
...
- [ ] Demo seed data creates education and supplement records.
...
- [ ] Education resource upload URL endpoint creates R2-backed object ids.
...
- [ ] Storage tests cover education upload URL validation.
- [ ] Component tests cover API-backed education UI.
- [ ] Component tests cover API-backed supplement UI.
- [ ] E2E tests cover education and supplement flows.
...
Review steps:
- [ ] Compare code against education/supplementation product scope and this checklist.
...
- [ ] Verify all checklist items above are complete or explicitly deferred outside M9 through updated roadmap docs.
- [ ] Run migrations against a clean database.
- [ ] Run seed against a clean database.
- [ ] Run education API tests.
- [ ] Run supplement API tests.
- [ ] Run storage access tests.
- [ ] Run education/supplement E2E flows.
- [ ] Run `pnpm --dir apps/web check`.
- [ ] Close every gap before M9 is marked complete.
