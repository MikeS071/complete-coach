...
Status: In Progress. Tickets 014A through 014C are complete with schema, exercise APIs, seed data, API-backed exercise UI persistence, API-backed program library assignment UI, and scoped exercise media upload authorization.
