...
Status: In Progress. Tickets 014A through 014D are complete with schema, exercise APIs, seed data, API-backed exercise UI persistence, API-backed program library assignment UI, scoped exercise media upload authorization, and client profile training integration.
