...
Status: In Progress. Ticket 017A is complete with package/payment schema foundations and tenant-scoped package APIs; continue with Ticket 017B for Stripe Connect onboarding and account-link flow.
